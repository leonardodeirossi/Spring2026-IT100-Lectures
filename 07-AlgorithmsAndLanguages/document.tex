...
\begin{frame}{I problemi e la loro soluzione (3)}
    \begin{block}{Definizione: problema}
        ...
        La \textbf{soluzione} di un problema consiste nella definizione della procedura, ovvero le operazioni che devono essere eseguite per raggiungere lo scopo desiderato.
    \end{block}
\end{frame}
